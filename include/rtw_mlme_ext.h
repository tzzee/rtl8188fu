...
extern unsigned char rtl8188fu_WMM_INFO_OUI[];
extern unsigned char rtl8188fu_WMM_PARA_OUI[];
...
#define rtw_is_channel_plan_valid(chplan) (((chplan) < RTW_CHPLAN_MAX || (chplan) == RTW_CHPLAN_REALTEK_DEFINE) && !rtl8188fu_rtw_chplan_is_empty(chplan))
...
#ifdef CONFIG_DFS_MASTER
struct rf_ctl_t;
#define CH_IS_NON_OCP(rt_ch_info) ((rt_ch_info)->non_ocp_end_time > rtl8188fu_rtw_get_current_time())
...
#endif
	//rtl8188fu_recv_decache check for Action_public frame 
...
#define mlmeext_rtl8188fu_scan_state_str(mlmeext) rtl8188fu_scan_state_str((mlmeext)->sitesurvey_res.state)
...
#define mlmeext_set_scan_state(mlmeext, _state) \
	do { \
		...
		/* DBG_871X("set_scan_state:%s\n", rtl8188fu_scan_state_str(_state)); */ \
	} while (0)
...
extern void rtl8188fu_init_mlme_ext_timer(_adapter *padapter);
extern void rtl8188fu_init_addba_retry_timer(_adapter *padapter, struct sta_info *psta);
extern struct xmit_frame *rtl8188furtl8188fu__alloc_mgtxmitframe(struct xmit_priv *pxmitpriv);
struct xmit_frame *rtl8188furtl8188fu__rtl8188fu_alloc_mgtxmitframe_once(struct xmit_priv *pxmitpriv);
...
void rtl8188fu_UpdateBrateTbl(_adapter *padapter,u8 *mBratesOS);
...
u8 rtl8188fu_rtw_get_oper_ch(_adapter *adapter);
void rtl8188fu_rtw_set_oper_ch(_adapter *adapter, u8 ch);
u8 rtl8188fu_rtw_get_oper_bw(_adapter *adapter);
void rtl8188fu_rtw_set_oper_bw(_adapter *adapter, u8 bw);
u8 rtl8188fu_rtw_get_oper_choffset(_adapter *adapter);
void rtl8188fu_rtw_set_oper_choffset(_adapter *adapter, u8 offset);
u8	rtl8188fu_rtw_get_center_ch(u8 channel, u8 chnl_bw, u8 chnl_offset);
u32 rtl8188fu_rtw_get_on_oper_ch_time(_adapter *adapter);
u32 rtl8188fu_rtw_get_on_cur_ch_time(_adapter *adapter);
...
void rtl8188fu_write_cam_from_cache(_adapter *adapter, u8 id);

/* modify both HW and cache */
void rtl8188fu_write_cam(_adapter *padapter, u8 id, u16 ctrl, u8 *mac, u8 *key);
void rtl8188furtl8188fu__clear_cam_entry(_adapter *padapter, u8 id);
...
void rtl8188fu_CAM_empty_entry(PADAPTER Adapter, u8 ucIndex);

void rtl8188fu_flush_all_cam_entry(_adapter *padapter);

BOOLEAN rtl8188fu_IsLegal5GChannel(PADAPTER Adapter, u8 channel);
...
void rtl8188fu_update_network(WLAN_BSSID_EX *dst, WLAN_BSSID_EX *src, _adapter * padapter, bool update_ie);

int rtl8188fu_get_bsstype(unsigned short capability);
u8* rtl8188fu_get_my_bssid(WLAN_BSSID_EX *pnetwork);
...
#ifdef CONFIG_WFD
void rtl8188fu_rtw_process_wfd_ie(_adapter *adapter, u8 *ie, u8 ie_len, const char *tag);
...
void rtl8188fu_update_beacon_info(_adapter *padapter, u8 *pframe, uint len, struct sta_info *psta);
#ifdef CONFIG_DFS
...
void rtl8188fu_update_tx_basic_rate(_adapter *padapter, u8 modulation);
...
bool rtl8188fu__rtw_camctl_chk_cap(_adapter *adapter, u8 cap);
void _rtl8188furtl8188fu__rtw_camctl_set_flags(_adapter *adapter, u32 flags);
void rtl8188furtl8188fu__rtw_camctl_set_flags(_adapter *adapter, u32 flags);
void _rtl8188furtl8188fu__rtw_camctl_clr_flags(_adapter *adapter, u32 flags);
void rtl8188furtl8188fu__rtw_camctl_clr_flags(_adapter *adapter, u32 flags);
bool rtl8188fu__rtw_camctl_chk_flags(_adapter *adapter, u32 flags);

struct sec_cam_bmp;
void rtl8188fu_dump_sec_cam_map(void *sel, struct sec_cam_bmp *map, u8 max_num);
void rtl8188fu_rtw_sec_cam_map_clr_all(struct sec_cam_bmp *map);

bool rtl8188fu__rtl8188fu_rtw_camid_is_gk(_adapter *adapter, u8 cam_id);
bool rtl8188fu_rtw_camid_is_gk(_adapter *adapter, u8 cam_id);
...
bool rtl8188fu_rtw_macid_is_set(struct macid_bmp *map, u8 id);
bool rtl8188fu_rtw_macid_is_used(struct macid_ctl_t *macid_ctl, u8 id);
bool rtl8188fu_rtw_macid_is_bmc(struct macid_ctl_t *macid_ctl, u8 id);
s8 rtl8188fu_rtw_macid_get_if_g(struct macid_ctl_t *macid_ctl, u8 id);
s8 rtl8188fu_rtw_macid_get_ch_g(struct macid_ctl_t *macid_ctl, u8 id);
...
void rtl8188fu_rtw_macid_ctl_set_h2c_msr(struct macid_ctl_t *macid_ctl, u8 id, u8 h2c_msr);
void rtl8188fu_rtw_macid_ctl_init(struct macid_ctl_t *macid_ctl);
void rtl8188fu_rtw_macid_ctl_deinit(struct macid_ctl_t *macid_ctl);
...
extern u8 rtl8188fu_set_tx_beacon_cmd(_adapter*padapter);
...
void rtl8188fu_issue_probereq_p2p(_adapter *padapter, u8 *da);
int rtl8188furtl8188fu__rtl8188fu_issue_probereq_p2p_ex(_adapter *adapter, u8 *da, int try_cnt, int wait_ms);
void rtl8188fu_issue_p2p_invitation_response(_adapter *padapter, u8* raddr, u8 dialogToken, u8 success);
...
void rtl8188fu_issue_probereq(_adapter *padapter, NDIS_802_11_SSID *pssid, u8 *da);
s32 rtl8188furtl8188fu__rtl8188fu_issue_probereq_ex(_adapter *padapter, NDIS_802_11_SSID *pssid, u8* da, u8 ch, bool append_wps, int try_cnt, int wait_ms);
...
int rtl8188fu_issue_deauth_ex(_adapter *padapter, u8 *da, unsigned short reason, int try_cnt, int wait_ms);
void rtl8188fu_issue_action_spct_ch_switch(_adapter *padapter, u8 *ra, u8 new_ch, u8 ch_offset);
void rtl8188fu_issue_addba_req(_adapter *adapter, unsigned char *ra, u8 tid);
void rtl8188fu_issue_addba_rsp(_adapter *adapter, unsigned char *ra, u8 tid, u16 status, u8 size);
u8 rtl8188fu_issue_addba_rsp_wait_ack(_adapter *adapter, unsigned char *ra, u8 tid, u16 status, u8 size, int try_cnt, int wait_ms);
void rtl8188fu_issue_del_ba(_adapter *adapter, unsigned char *ra, u8 tid, u16 reason, u8 initiator);
int rtl8188fu_issue_del_ba_ex(_adapter *adapter, unsigned char *ra, u8 tid, u16 reason, u8 initiator, int try_cnt, int wait_ms);
...
unsigned int rtl8188fu_send_delba_sta_tid(_adapter *adapter, u8 initiator, struct sta_info *sta, u8 tid, u8 force);
unsigned int rtl8188fu_rtl8188fu_send_delba_sta_tid_wait_ack(_adapter *adapter, u8 initiator, struct sta_info *sta, u8 tid, u8 force);
...
extern int rtl8188fu_cckrates_included(unsigned char *rate, int ratelen);
extern int rtl8188fu_cckratesonly_included(unsigned char *rate, int ratelen);

extern void rtl8188fu_process_addba_req(_adapter *padapter, u8 *paddba_req, u8 *addr);

extern void rtl8188fu_update_TSF(struct mlme_ext_priv *pmlmeext, u8 *pframe, uint len);
extern void rtl8188fu_correct_TSF(_adapter *padapter, struct mlme_ext_priv *pmlmeext);
extern void rtl8188fu_adaptive_early_32k(struct mlme_ext_priv *pmlmeext, u8 *pframe, uint len);
extern u8 rtl8188fu_traffic_status_watchdog(_adapter *padapter, u8 from_timer);
...
void rtl8188fu_rtw_join_done_chk_ch(_adapter *padapter, int join_res);

int rtw_chk_rtl8188fu_start_clnt_join(_adapter *padapter, u8 *ch, u8 *bw, u8 *offset);
...
u8 rtl8188fu_read_macreg_hdl(_adapter *padapter, u8 *pbuf);
u8 rtl8188fu_write_macreg_hdl(_adapter *padapter, u8 *pbuf);
u8 rtl8188fu_read_bbreg_hdl(_adapter *padapter, u8 *pbuf);
u8 rtl8188fu_write_bbreg_hdl(_adapter *padapter, u8 *pbuf);
u8 rtl8188fu_read_rfreg_hdl(_adapter *padapter, u8 *pbuf);
u8 rtl8188furtl8188fu__write_rfreg_hdl(_adapter *padapter, u8 *pbuf);


u8 rtl8188fu_NULL_hdl(_adapter *padapter, u8 *pbuf);
u8 rtl8188fu_join_cmd_hdl(_adapter *padapter, u8 *pbuf);
u8 rtl8188fu_disconnect_hdl(_adapter *padapter, u8 *pbuf);
...
u8 rtl8188fu_setauth_hdl(_adapter *padapter, u8 *pbuf);
...
u8 rtl8188fu_set_csa_hdl(_adapter *padapter, unsigned char *pbuf);	//Kurt: Handling DFS channel switch announcement ie.
...
#define GEN_DRV_CMD_HANDLER(size, cmd)	{size, &rtl8188fu_##cmd##_hdl},
#define GEN_MLME_EXT_HANDLER(size, cmd)	{size, cmd},

#ifdef _RTW_CMD_C_

struct cmd_hdl rtl8188fu_wlancmds[] = 
{
	...
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(0, NULL)		
	GEN_MLME_EXT_HANDLER(sizeof (struct joinbss_parm), rtl8188fu_join_cmd_hdl) /*14*/
	GEN_MLME_EXT_HANDLER(sizeof (struct disconnect_parm), rtl8188fu_disconnect_hdl)
	GEN_MLME_EXT_HANDLER(sizeof (struct createbss_parm), rtl8188fu_createbss_hdl)
	GEN_MLME_EXT_HANDLER(sizeof (struct setopmode_parm), rtl8188fu_setopmode_hdl)
	GEN_MLME_EXT_HANDLER(sizeof (struct sitesurvey_parm), rtl8188fu_sitesurvey_cmd_hdl) /*18*/
	GEN_MLME_EXT_HANDLER(sizeof (struct setauth_parm), rtl8188fu_setauth_hdl)
	GEN_MLME_EXT_HANDLER(sizeof (struct setkey_parm), rtl8188fu_setkey_hdl) /*20*/
	GEN_MLME_EXT_HANDLER(sizeof (struct set_stakey_parm), rtl8188fu_set_stakey_hdl)
	...
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(sizeof(struct addBaReq_parm), rtl8188fu_add_ba_hdl)	
	GEN_MLME_EXT_HANDLER(sizeof(struct set_ch_parm), rtl8188fu_set_ch_hdl) /* 46 */
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(0, NULL)
	...
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(0, NULL) 
	GEN_MLME_EXT_HANDLER(sizeof(struct Tx_Beacon_param), rtl8188fu_tx_beacon_hdl) /*55*/

	GEN_MLME_EXT_HANDLER(0, rtl8188fu_mlme_evt_hdl) /*56*/
	GEN_MLME_EXT_HANDLER(0, rtl8188fu_rtw_drvextra_cmd_hdl) /*57*/

	GEN_MLME_EXT_HANDLER(0, rtl8188fu_h2c_msg_hdl) /*58*/
	GEN_MLME_EXT_HANDLER(sizeof(struct rtl8188fu_SetChannelPlan_param), rtl8188fu_set_chplan_hdl) /*59*/
	GEN_MLME_EXT_HANDLER(sizeof(struct LedBlink_param), rtl8188fu_led_blink_hdl) /*60*/

	GEN_MLME_EXT_HANDLER(sizeof(struct rtl8188fu_SetChannelSwitch_param), rtl8188fu_set_csa_hdl) /*61*/
	GEN_MLME_EXT_HANDLER(sizeof(struct TDLSoption_param), rtl8188fu_tdls_hdl) /*62*/
	GEN_MLME_EXT_HANDLER(0, rtl8188fu_chk_bmc_sleepq_hdl) /*63*/
	GEN_MLME_EXT_HANDLER(sizeof(struct RunInThread_param), rtl8188fu_run_in_thread_hdl) /*64*/
	GEN_MLME_EXT_HANDLER(sizeof(struct addBaRsp_parm), rtl8188fu_add_ba_rsp_hdl) /* 65 */
};
...
{
	{0, rtl8188fu_rtw_dummy_event_callback}, 	/*0*/
	{0, NULL},
	{0, NULL},
	{0, NULL},
	{0, NULL},
	...
	{0, NULL},
	{0, NULL},
	{0, &rtl8188fu_rtw_survey_event_callback},		/*8*/
	{sizeof (struct surveydone_event), &rtl8188fu_rtw_surveydone_event_callback},	/*9*/
		
	{0, &rtl8188fu_rtw_joinbss_event_callback},		/*10*/
	{sizeof(struct stassoc_event), &rtl8188fu_rtw_stassoc_event_callback},
	{sizeof(struct stadel_event), &rtl8188fu_rtw_stadel_event_callback},	
	{0, &rtl8188fu_rtw_atimdone_event_callback},
	{0, rtl8188fu_rtw_dummy_event_callback},
	{0, NULL},	/*15*/
	{0, NULL},
	{0, NULL},
	{0, NULL},
	{0, rtl8188fu_rtw_fwdbg_event_callback},
	{0, NULL},	 /*20*/
	{0, NULL},
	{0, NULL},
	{0, &rtl8188fu_rtw_cpwm_event_callback},
	{0, NULL},
	{0, &rtl8188fu_rtw_wmm_event_callback}, /*25*/
#ifdef CONFIG_IEEE80211W
