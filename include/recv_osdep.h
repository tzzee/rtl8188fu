...
extern sint rtl8188fu__rtw_init_recv_priv(struct recv_priv *precvpriv, _adapter *padapter);
extern void rtl8188fu__rtw_free_recv_priv (struct recv_priv *precvpriv);


extern s32  rtl8188fu_rtw_recv_entry(union recv_frame *precv_frame);	
extern int rtl8188fu_rtw_recv_indicatepkt(_adapter *adapter, union recv_frame *precv_frame);
extern void rtw_recv_returnpacket(IN _nic_hdl cnxt, IN _pkt *preturnedpkt);

extern int rtl8188fu_rtw_recv_monitor(_adapter *padapter, union recv_frame *precv_frame);

extern void rtl8188fu_rtw_hostapd_mlme_rx(_adapter *padapter, union recv_frame *precv_frame);

struct sta_info;
extern void rtl8188fu_rtw_handle_tkip_mic_err(_adapter *padapter, struct sta_info *sta, u8 bgroup);
