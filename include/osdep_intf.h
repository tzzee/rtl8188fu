...
uint rtl8188fu_loadparam(_adapter *adapter);
...
struct net_device *rtl8188fu_rtw_init_netdev(_adapter *padapter);
...
extern int rtl8188fu_rtw_ioctl(struct ifnet * ifp, u_long cmd, caddr_t data);
#endif
...
void rtl8188fu_rtw_ndev_destructor(_nic_hdl ndev);
