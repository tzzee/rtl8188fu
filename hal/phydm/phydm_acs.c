...
)
{
	...
	{
		ODM_RT_TRACE(pDM_Odm, ODM_COMP_ACS, ODM_DBG_LOUD, ("[ACS] rtl8188fu_ODM_GetAutoChannelSelectResult(): CleanChannel_2G(%d)\n", pACS->CleanChannel_2G));
		return (u1Byte)pACS->CleanChannel_2G;	
	}
	else
	{
		ODM_RT_TRACE(pDM_Odm, ODM_COMP_ACS, ODM_DBG_LOUD, ("[ACS] rtl8188fu_ODM_GetAutoChannelSelectResult(): CleanChannel_5G(%d)\n", pACS->CleanChannel_5G));
...
VOID
rtl8188fu_odm_AutoChannelSelectSetting(
	IN		PVOID			pDM_VOID,
	IN		BOOLEAN			IsEnable
)
{
	...
	ODM_RT_TRACE(pDM_Odm, ODM_COMP_ACS, ODM_DBG_LOUD, ("rtl8188fu_odm_AutoChannelSelectSetting()=========> \n"));
	...
	if(pDM_Odm->SupportICType & ODM_IC_11AC_SERIES)
	{
		...
		rtl8188fu_ODM_Write2Byte(pDM_Odm, ODM_REG_NHM_TIMER_11AC+2, period);	//0x990[31:16]=0x2710	Time duration for NHM unit: 4us, 0x2710=40ms
		//rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_NHM_TH9_TH10_11AC, BIT8|BIT9|BIT10, NHMType);	//0x994[9:8]=3			enable CCX
	}
	else if (pDM_Odm->SupportICType & ODM_IC_11N_SERIES)
	{
		//PHY parameters initialize for n series
		rtl8188fu_ODM_Write2Byte(pDM_Odm, ODM_REG_NHM_TIMER_11N+2, period);	//0x894[31:16]=0x2710	Time duration for NHM unit: 4us, 0x2710=40ms
		//rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_NHM_TH9_TH10_11N, BIT10|BIT9|BIT8, NHMType);	//0x890[9:8]=3			enable CCX		
	}
#endif
}
...
)
{
	...
	ODM_RT_TRACE(pDM_Odm, ODM_COMP_ACS, ODM_DBG_LOUD, ("rtl8188fu_odm_AutoChannelSelectInit()=========> \n"));
...
)
{
	...
	ODM_RT_TRACE(pDM_Odm, ODM_COMP_ACS, ODM_DBG_LOUD, ("rtl8188fu_odm_AutoChannelSelectReset()=========> \n"));

	rtl8188fu_odm_AutoChannelSelectSetting(pDM_Odm,TRUE);// for 20ms measurement
...
)
{
	...
	if(!(pDM_Odm->SupportAbility & ODM_BB_NHM_CNT))
	{
		ODM_RT_TRACE(pDM_Odm,ODM_COMP_DIG, ODM_DBG_LOUD, ("rtl8188fu_odm_AutoChannelSelect(): Return: SupportAbility ODM_BB_NHM_CNT is disabled\n"));
		return;
	}

	if(pACS->bForceACSResult)
	{
		ODM_RT_TRACE(pDM_Odm,ODM_COMP_DIG, ODM_DBG_LOUD, ("rtl8188fu_odm_AutoChannelSelect(): Force 2G clean channel = %d, 5G clean channel = %d\n",
			pACS->CleanChannel_2G, pACS->CleanChannel_5G));
		return;
	}

	ODM_RT_TRACE(pDM_Odm, ODM_COMP_ACS, ODM_DBG_LOUD, ("rtl8188fu_odm_AutoChannelSelect(): Channel = %d=========> \n", Channel));

	rtl8188fu_Phydm_GetNHMCounterStatistics(pDM_Odm);
	rtl8188fu_odm_AutoChannelSelectSetting(pDM_Odm,FALSE);
	...
	if(Channel >=1 && Channel <=14)
	{
		...
		ODM_RT_TRACE(pDM_Odm, ODM_COMP_ACS, ODM_DBG_LOUD, ("rtl8188fu_odm_AutoChannelSelect(): NHM_cnt_0 = %d \n", pDM_Odm->NHM_cnt_0));
		ODM_RT_TRACE(pDM_Odm, ODM_COMP_ACS, ODM_DBG_LOUD, ("rtl8188fu_odm_AutoChannelSelect(): Channel_Info[0][%d] = %d, Channel_Info[1][%d] = %d\n", ChannelIDX, pACS->Channel_Info_2G[0][ChannelIDX], ChannelIDX, pACS->Channel_Info_2G[1][ChannelIDX]));
		...
		ODM_RT_TRACE(pDM_Odm, ODM_COMP_ACS, ODM_DBG_LOUD, ("(1)rtl8188fu_odm_AutoChannelSelect(): 2G: CleanChannel_2G = %d, MaxScore = %d \n", 
...
)
{
    ...
    ODM_RT_TRACE(pDM_Odm, ODM_COMP_ACS, ODM_DBG_LOUD, ("rtl8188fu_odm_AutoChannelSelectSettingAP()=========> \n"));
    ...
    if(setting == STORE_DEFAULT_NHM_SETTING)
    {
        ...
        {
            pACS->Reg0x990 = rtl8188fu_ODM_Read4Byte(pDM_Odm, ODM_REG_NHM_TIMER_11AC);                // Reg0x990
            pACS->Reg0x994 = rtl8188fu_ODM_Read4Byte(pDM_Odm, ODM_REG_NHM_TH9_TH10_11AC);           // Reg0x994
            pACS->Reg0x998 = rtl8188fu_ODM_Read4Byte(pDM_Odm, ODM_REG_NHM_TH3_TO_TH0_11AC);       // Reg0x998
            pACS->Reg0x99C = rtl8188fu_ODM_Read4Byte(pDM_Odm, ODM_REG_NHM_TH7_TO_TH4_11AC);       // Reg0x99c
            pACS->Reg0x9A0 = rtl8188fu_ODM_Read1Byte(pDM_Odm, ODM_REG_NHM_TH8_11AC);                   // Reg0x9a0, u1Byte            
        }
        else if(pDM_Odm->SupportICType & ODM_IC_11N_SERIES)
        {
            pACS->Reg0x890 = rtl8188fu_ODM_Read4Byte(pDM_Odm, ODM_REG_NHM_TH9_TH10_11N);             // Reg0x890
            pACS->Reg0x894 = rtl8188fu_ODM_Read4Byte(pDM_Odm, ODM_REG_NHM_TIMER_11N);                  // Reg0x894
            pACS->Reg0x898 = rtl8188fu_ODM_Read4Byte(pDM_Odm, ODM_REG_NHM_TH3_TO_TH0_11N);         // Reg0x898
            pACS->Reg0x89C = rtl8188fu_ODM_Read4Byte(pDM_Odm, ODM_REG_NHM_TH7_TO_TH4_11N);         // Reg0x89c
            pACS->Reg0xE28 = rtl8188fu_ODM_Read1Byte(pDM_Odm, ODM_REG_NHM_TH8_11N);                     // Reg0xe28, u1Byte    
        }
    }
    ...
    else if(setting == RESTORE_DEFAULT_NHM_SETTING)
    {
        ...
        if(pDM_Odm->SupportICType & ODM_IC_11AC_SERIES)     // store Reg0x990, Reg0x994, Reg0x998, Reg0x99C, Reg0x9a0
        {
            rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TIMER_11AC,          pACS->Reg0x990);
            rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH9_TH10_11AC,     pACS->Reg0x994);
            rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH3_TO_TH0_11AC, pACS->Reg0x998);
            rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH7_TO_TH4_11AC, pACS->Reg0x99C);
            rtl8188fu_ODM_Write1Byte(pDM_Odm, ODM_REG_NHM_TH8_11AC,             pACS->Reg0x9A0);   
        }
        else if(pDM_Odm->SupportICType & ODM_IC_11N_SERIES)
        {
            rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH9_TH10_11N,     pACS->Reg0x890);
            rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TIMER_11N,          pACS->Reg0x894);
            rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH3_TO_TH0_11N, pACS->Reg0x898);
            rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH7_TO_TH4_11N, pACS->Reg0x89C);
            rtl8188fu_ODM_Write1Byte(pDM_Odm, ODM_REG_NHM_TH8_11N,             pACS->Reg0xE28); 
        }        
    }
    ...
    {        
        ...
        {   
            ...
            rtl8188fu_ODM_Write2Byte(pDM_Odm, ODM_REG_NHM_TIMER_11AC+2, period);
            //4 Set NHM ignore_cca=1, ignore_txon=1, ccx_en=0
            rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_NHM_TH9_TH10_11AC,BIT8|BIT9|BIT10, 3);
            
            if(pACS->ACS_Step == 0)
            {
                //4 Set IGI
                rtl8188fu_ODM_SetBBReg(pDM_Odm,0xc50,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x3E);
                if (get_rf_mimo_mode(priv) != MIMO_1T1R)
					rtl8188fu_ODM_SetBBReg(pDM_Odm,0xe50,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x3E);
                    
                //4 Set ACS NHM threshold
                rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH3_TO_TH0_11AC, 0x82786e64);
                rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH7_TO_TH4_11AC, 0xffffff8c);
                rtl8188fu_ODM_Write1Byte(pDM_Odm, ODM_REG_NHM_TH8_11AC, 0xff);
                rtl8188fu_ODM_Write2Byte(pDM_Odm, ODM_REG_NHM_TH9_TH10_11AC+2, 0xffff);
                
            }
            else if(pACS->ACS_Step == 1)
            {
                //4 Set IGI
                rtl8188fu_ODM_SetBBReg(pDM_Odm,0xc50,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x2A);
                if (get_rf_mimo_mode(priv) != MIMO_1T1R)
					rtl8188fu_ODM_SetBBReg(pDM_Odm,0xe50,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x2A);

                //4 Set ACS NHM threshold
                rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH3_TO_TH0_11AC, 0x5a50463c);
                rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH7_TO_TH4_11AC, 0xffffff64);
        ...
        else if (pDM_Odm->SupportICType & ODM_IC_11N_SERIES)
        {
            ...
            rtl8188fu_ODM_Write2Byte(pDM_Odm, ODM_REG_NHM_TIMER_11N+2, period);
            //4 Set NHM ignore_cca=1, ignore_txon=1, ccx_en=0
            rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_NHM_TH9_TH10_11N,BIT8|BIT9|BIT10, 3);
            ...
            if(pACS->ACS_Step == 0)
            {
                ...
                rtl8188fu_ODM_SetBBReg(pDM_Odm,0xc50,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x3E);
                if (get_rf_mimo_mode(priv) != MIMO_1T1R)
					rtl8188fu_ODM_SetBBReg(pDM_Odm,0xc58,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x3E);
            
                //4 Set ACS NHM threshold
                rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH3_TO_TH0_11N, 0x82786e64);
                rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH7_TO_TH4_11N, 0xffffff8c);
                rtl8188fu_ODM_Write1Byte(pDM_Odm, ODM_REG_NHM_TH8_11N, 0xff);
                rtl8188fu_ODM_Write2Byte(pDM_Odm, ODM_REG_NHM_TH9_TH10_11N+2, 0xffff);
            ...
            else if(pACS->ACS_Step == 1)
            {
                ...
                rtl8188fu_ODM_SetBBReg(pDM_Odm,0xc50,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x2A);
                if (get_rf_mimo_mode(priv) != MIMO_1T1R)
					rtl8188fu_ODM_SetBBReg(pDM_Odm,0xc58,BIT0|BIT1|BIT2|BIT3|BIT4|BIT5|BIT6,0x2A);
            
                //4 Set ACS NHM threshold
                rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH3_TO_TH0_11N, 0x5a50463c);
                rtl8188fu_ODM_Write4Byte(pDM_Odm, ODM_REG_NHM_TH7_TO_TH4_11N, 0xffffff64);
...
)
{
    ...
    if(pDM_Odm->SupportICType & ODM_IC_11N_SERIES)
    {
        ...
        for (i=0; i<20; i++) {
            ...
            if ( rtl8188fu_ODM_GetBBReg(pDM_Odm,rFPGA0_PSDReport,BIT17) )
                break;
        }
        ...
        if ( pACS->ACS_Step==1 ) {
            ...
            value32 = rtl8188fu_ODM_Read4Byte(pDM_Odm,ODM_REG_NHM_CNT7_TO_CNT4_11N);
            
            pACS->NHM_Cnt[idx][9] = (value32 & bMaskByte1) >> 8;
            pACS->NHM_Cnt[idx][8] = (value32 & bMaskByte0);

            value32 = rtl8188fu_ODM_Read4Byte(pDM_Odm,ODM_REG_NHM_CNT_11N);    // ODM_REG_NHM_CNT3_TO_CNT0_11N
            ...
            pACS->NHM_Cnt[idx][4] = rtl8188fu_ODM_Read1Byte(pDM_Odm, ODM_REG_NHM_CNT7_TO_CNT4_11N);            
    ...
    else if(pDM_Odm->SupportICType & ODM_IC_11AC_SERIES)
    {
        ...
        for (i=0; i<20; i++) {
            ...
            rtl8188fu_ODM_delay_ms(1);
            if (rtl8188fu_ODM_GetBBReg(pDM_Odm,ODM_REG_NHM_DUR_READY_11AC,BIT17))
                break;
        }
    
        if ( pACS->ACS_Step==1 ) {
            
            value32 = rtl8188fu_ODM_Read4Byte(pDM_Odm,ODM_REG_NHM_CNT7_TO_CNT4_11AC);
            
            pACS->NHM_Cnt[idx][9] = (value32 & bMaskByte1) >> 8;
            pACS->NHM_Cnt[idx][8] = (value32 & bMaskByte0);

            value32 = rtl8188fu_ODM_Read4Byte(pDM_Odm,ODM_REG_NHM_CNT_11AC);     // ODM_REG_NHM_CNT3_TO_CNT0_11AC
            ...
            pACS->NHM_Cnt[idx][4] = rtl8188fu_ODM_Read1Byte(pDM_Odm, ODM_REG_NHM_CNT7_TO_CNT4_11AC);            
            pACS->NHM_Cnt[idx][3] = (value32 & bMaskByte3) >> 24;
            pACS->NHM_Cnt[idx][2] = (value32 & bMaskByte2) >> 16;
            pACS->NHM_Cnt[idx][1] = (value32 & bMaskByte1) >> 8;
            pACS->NHM_Cnt[idx][0] = (value32 & bMaskByte0);
...
// DELETE
	...
	for (i=0; i<priv->rtl8188fu_site_survey->count; i++) {
		pBss = &priv->rtl8188fu_site_survey->bss[i];
...
)
{
	...
	if (pDM_Odm->SupportICType & ODM_IC_11AC_SERIES) {
		rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_CLM_TIME_PERIOD_11AC, bMaskLWord, sampleNum);	/*4us sample 1 time*/
		rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_CLM_11AC, BIT8, 0x1);							/*Enable CCX for CLM*/
	} else if (pDM_Odm->SupportICType & ODM_IC_11N_SERIES) {
		rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_CLM_TIME_PERIOD_11N, bMaskLWord, sampleNum);	/*4us sample 1 time*/
		rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_CLM_11N, BIT8, 0x1);								/*Enable CCX for CLM*/	
	}
...
)
{
	...
	if (pDM_Odm->SupportICType & ODM_IC_11AC_SERIES) {
		rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_CLM_11AC, BIT0, 0x0);	/*Trigger CLM*/
		rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_CLM_11AC, BIT0, 0x1);
	} else if (pDM_Odm->SupportICType & ODM_IC_11N_SERIES) {
		rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_CLM_11N, BIT0, 0x0);	/*Trigger CLM*/
		rtl8188fu_ODM_SetBBReg(pDM_Odm, ODM_REG_CLM_11N, BIT0, 0x1);
	}
}
...
)
{
	...
	if (pDM_Odm->SupportICType & ODM_IC_11AC_SERIES)
		value32 = rtl8188fu_ODM_GetBBReg(pDM_Odm, ODM_REG_CLM_RESULT_11AC, bMaskDWord);				/*make sure CLM calc is ready*/
	else if (pDM_Odm->SupportICType & ODM_IC_11N_SERIES)
		value32 = rtl8188fu_ODM_GetBBReg(pDM_Odm, ODM_REG_CLM_READY_11N, bMaskDWord);				/*make sure CLM calc is ready*/
...
)
{
	...
	if (pDM_Odm->SupportICType & ODM_IC_11AC_SERIES)
		value32 = rtl8188fu_ODM_GetBBReg(pDM_Odm, ODM_REG_CLM_RESULT_11AC, bMaskDWord);				/*read CLM calc result*/
	else if (pDM_Odm->SupportICType & ODM_IC_11N_SERIES)
		value32 = rtl8188fu_ODM_GetBBReg(pDM_Odm, ODM_REG_CLM_RESULT_11N, bMaskDWord);				/*read CLM calc result*/
